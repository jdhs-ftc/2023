...
public class RedTeamPropDeterminationPipeline extends OpenCvPipeline
{
    ...
    public RedTeamPropDeterminationPipeline(Telemetry telemetry) {
     ...
     */
    public PropPosition getAnalysis() { return position; }
